...
var credentials = {
	clientID: '802423763112102',
	clientSecret: 'cdaabf9706067f79333cd64c5ab7e859',
	callbackURL: 'http://fantn.herokuapp.com/auth/facebook?cb'
};
...
exports.authenticateUser = function(req, res, next)
{
	...
	if (req.cookies.target && req.cookies.target == 'app') {
        console.log('redirector to app: ' + req.cookies.target);
        redirect = '/auth/app';
    }
